...
fun main(){
    ...
    // 객체지향 프로글매의 반대의 개념이 구조화 프로그램이다. 이는 함수 중심으로 프로그램의 시작과 끝이 관리된다.
    // 코틀린의 자료들은 클래스로, 프로그램 시작과 끝의 관리는 함수로 병행하여 운용되는 형태이다.

    // 생셩된 클래스 형태로 객체를 생성한다.
    ...
    //obj.a1 = 100 // 에러 : 'setter가 없는 a1변수는 값을 변경할 수 없다.'
    obj5.a2 = 200
    println("obj5.a2 : ${obj5.a2}")
    obj5.testMethod1()
    obj5.testMethod2()
...
class TestClass3{
    ...
    var a2:Int = 0      // getter와 setter가 모두 생성되는 var 변수는 밑줄이 표시된다.
